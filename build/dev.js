...
const main = async function () {
  ...
  try {
    ...
    if (init || isKeep) {
      ...
      const nodeKey = { priv_key: { type: 'tendermint/PrivKeyEd25519', value: 'ggl/VtKrHieAP4T2SiOvZcmVyAoU223akLFh9yAfHrgFRZT3YVRQxhCH95PMkXvA5gCZhJU7Yr63f94BO69mbg==' } };
      const privValidatorConsensusKey = { address: '0176D23075D7281F0801EE93A249277BC467CBC0', pub_key: { type: 'tendermint/PubKeyEd25519', value: 'YJcd/+duDs3rxJ1PkwbC5BQytO6yK60RC0XVHA594ck=' }, priv_key: { type: 'tendermint/PrivKeyEd25519', value: '5rimRtjOgBEylz1uyY3xuhFWc00oEsXV08J5Tvw781tglx3/524OzevEnU+TBsLkFDK07rIrrRELRdUcDn3hyQ==' } };
      const createValidator = {
          ...
          messages: [
            {
              ...
              pubkey: { '@type': '/cosmos.crypto.ed25519.PubKey', key: 'YJcd/+duDs3rxJ1PkwbC5BQytO6yK60RC0XVHA594ck=' },
              ...
              bls_key: 'a547a187ae6925835edc80790611f3d2376a42314f653e1a73db9650427afd1714e6bba474fe2618f8a47f6d5d7506c9',
              bls_proof: '9034144d203a42fbf61993d194b8149ea00afbec3a6ce75eedc0a55023f1ae07ca4305d8f43d01d0b772bce9a356fbab1382826ceb01d33de9c4e093a615d396f350a77a5e24ac1ede74cbe498da648bdefdf01d50d557232bd02e56a7b6fb15',
            },
          ],
        ...
        signatures: ['LHWs3p4h0sXl93qO81g8o0NvvfBEbujdvvW/XPd8/2NuonUndBEfZSXFB3x+ukv4hjlUU4hO2/vvB270vKfa/wE='],
      };
      ...
      if (!isKeep) {
        ...
        for (let i = 0; i < nodesCount; i++) {
          ...
          appState.auth.accounts.unshift(Object.assign(JSON.parse(JSON.stringify(account)), { base_account: { address: '0x0000000000000000000000000000000000000000' } }));
