...
import (
	...
	types_2 "github.com/evmos/evmos/v12/x/permission/types"
...
var (
	...
	pattern_Query_HeadShadowObject_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3, 1, 0, 4, 1, 5, 4}, []string{"greenfield", "storage", "head_shadow_object", "bucket_name", "object_name"}, "", runtime.AssumeColonVerbOpt(false)))
	...
	pattern_Query_ListGroups_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"greenfield", "storage", "list_groups", "group_owner"}, "", runtime.AssumeColonVerbOpt(false)))
	...
	pattern_Query_HeadBucketExtra_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"greenfield", "storage", "head_bucket_extra", "bucket_name"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_QueryIsPriceChanged_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"greenfield", "storage", "is_price_changed", "bucket_name"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_QueryQuotaUpdateTime_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"greenfield", "storage", "quota_update_time", "bucket_name"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_QueryGroupMembersExist_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3, 1, 0, 4, 1, 5, 4}, []string{"greenfield", "storage", "group_members_exist", "group_id", "members"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_QueryGroupsExist_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3, 1, 0, 4, 1, 5, 4}, []string{"greenfield", "storage", "groups_exist", "group_owner", "group_names"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_QueryGroupsExistById_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"greenfield", "storage", "groups_exist_by_id", "group_ids"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_QueryPaymentAccountBucketFlowRateLimit_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3, 1, 0, 4, 1, 5, 4}, []string{"greenfield", "storage", "payment_account_bucket_flow_rate_limit", "payment_account", "bucket_name"}, "", runtime.AssumeColonVerbOpt(false)))
)
