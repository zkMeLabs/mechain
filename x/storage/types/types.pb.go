...
// source: mechain/storage/types.proto
...
type BucketInfo struct {
	...
	BucketStatus BucketStatus `protobuf:"varint,10,opt,name=bucket_status,json=bucketStatus,proto3,enum=mechain.storage.BucketStatus" json:"bucket_status,omitempty"`
...
type ObjectInfo struct {
	...
	Visibility VisibilityType `protobuf:"varint,8,opt,name=visibility,proto3,enum=mechain.storage.VisibilityType" json:"visibility,omitempty"`
	...
	ObjectStatus ObjectStatus `protobuf:"varint,11,opt,name=object_status,json=objectStatus,proto3,enum=mechain.storage.ObjectStatus" json:"object_status,omitempty"`
	// redundancy_type define the type of the redundancy which can be multi-replication or EC.
	RedundancyType RedundancyType `protobuf:"varint,12,opt,name=redundancy_type,json=redundancyType,proto3,enum=mechain.storage.RedundancyType" json:"redundancy_type,omitempty"`
	// source_type define the source of the object.
	SourceType SourceType `protobuf:"varint,13,opt,name=source_type,json=sourceType,proto3,enum=mechain.storage.SourceType" json:"source_type,omitempty"`
...
type GroupInfo struct {
	...
	// source_type
	SourceType SourceType `protobuf:"varint,3,opt,name=source_type,json=sourceType,proto3,enum=mechain.storage.SourceType" json:"source_type,omitempty"`
...
func init() {
	proto.RegisterType((*BucketInfo)(nil), "mechain.storage.BucketInfo")
	proto.RegisterType((*InternalBucketInfo)(nil), "mechain.storage.InternalBucketInfo")
	proto.RegisterType((*ObjectInfo)(nil), "mechain.storage.ObjectInfo")
	proto.RegisterType((*GroupInfo)(nil), "mechain.storage.GroupInfo")
	proto.RegisterType((*Trait)(nil), "mechain.storage.Trait")
	proto.RegisterType((*BucketMetaData)(nil), "mechain.storage.BucketMetaData")
	proto.RegisterType((*ObjectMetaData)(nil), "mechain.storage.ObjectMetaData")
	proto.RegisterType((*GroupMetaData)(nil), "mechain.storage.GroupMetaData")
	proto.RegisterType((*Ids)(nil), "mechain.storage.Ids")
	proto.RegisterType((*DeleteInfo)(nil), "mechain.storage.DeleteInfo")
	proto.RegisterType((*MigrationBucketInfo)(nil), "mechain.storage.MigrationBucketInfo")
	proto.RegisterType((*ResourceTags)(nil), "mechain.storage.ResourceTags")
	proto.RegisterType((*ResourceTags_Tag)(nil), "mechain.storage.ResourceTags.Tag")
	proto.RegisterType((*ShadowObjectInfo)(nil), "mechain.storage.ShadowObjectInfo")
	proto.RegisterType((*BucketExtraInfo)(nil), "mechain.storage.BucketExtraInfo")
}

func init() { proto.RegisterFile("mechain/storage/types.proto", fileDescriptor_4343cf2244f81514) }
