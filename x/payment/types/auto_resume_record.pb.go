...
// source: mechain/payment/auto_resume_record.proto
...
func init() {
	proto.RegisterType((*AutoResumeRecord)(nil), "mechain.payment.AutoResumeRecord")
}

func init() {
	proto.RegisterFile("mechain/payment/auto_resume_record.proto", fileDescriptor_09ae9afc6b714550)
}
