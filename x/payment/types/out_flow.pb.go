...
// source: mechain/payment/out_flow.proto
...
type OutFlow struct {
	...
	// status
	Status OutFlowStatus `protobuf:"varint,3,opt,name=status,proto3,enum=mechain.payment.OutFlowStatus" json:"status,omitempty"`
}
...
func init() {
	proto.RegisterEnum("mechain.payment.OutFlowStatus", OutFlowStatus_name, OutFlowStatus_value)
	proto.RegisterType((*OutFlow)(nil), "mechain.payment.OutFlow")
}

func init() { proto.RegisterFile("mechain/payment/out_flow.proto", fileDescriptor_b46717506b0c3976) }
