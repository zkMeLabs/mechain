...
// source: mechain/payment/events.proto
...
type EventStreamRecordUpdate struct {
	...
	Status StreamAccountStatus `protobuf:"varint,8,opt,name=status,proto3,enum=mechain.payment.StreamAccountStatus" json:"status,omitempty"`
...
type EventFeePreview struct {
	Account        string                                 `protobuf:"bytes,1,opt,name=account,proto3" json:"account,omitempty"`
	FeePreviewType FeePreviewType                         `protobuf:"varint,2,opt,name=fee_preview_type,json=feePreviewType,proto3,enum=mechain.payment.FeePreviewType" json:"fee_preview_type,omitempty"`
	Amount         github_com_cosmos_cosmos_sdk_types.Int `protobuf:"bytes,3,opt,name=amount,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Int" json:"amount"`
}
...
func init() {
	proto.RegisterEnum("mechain.payment.FeePreviewType", FeePreviewType_name, FeePreviewType_value)
	proto.RegisterType((*EventPaymentAccountUpdate)(nil), "mechain.payment.EventPaymentAccountUpdate")
	proto.RegisterType((*EventStreamRecordUpdate)(nil), "mechain.payment.EventStreamRecordUpdate")
	proto.RegisterType((*EventForceSettle)(nil), "mechain.payment.EventForceSettle")
	proto.RegisterType((*EventDeposit)(nil), "mechain.payment.EventDeposit")
	proto.RegisterType((*EventWithdraw)(nil), "mechain.payment.EventWithdraw")
	proto.RegisterType((*EventFeePreview)(nil), "mechain.payment.EventFeePreview")
}

func init() { proto.RegisterFile("mechain/payment/events.proto", fileDescriptor_0e8b0c13ebea40be) }
