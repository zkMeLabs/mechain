...
// source: mechain/payment/payment_account.proto
...
func init() {
	proto.RegisterType((*PaymentAccount)(nil), "mechain.payment.PaymentAccount")
}

func init() {
	proto.RegisterFile("mechain/payment/payment_account.proto", fileDescriptor_f1b6bde8670bbe83)
}
