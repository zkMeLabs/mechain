...
type StorageProvider struct {
	...
	Status Status `protobuf:"varint,9,opt,name=status,proto3,enum=mechain.sp.Status" json:"status,omitempty"`
...
func init() {
	proto.RegisterEnum("mechain.sp.Status", Status_name, Status_value)
	proto.RegisterType((*Description)(nil), "mechain.sp.Description")
	proto.RegisterType((*StorageProvider)(nil), "mechain.sp.StorageProvider")
	proto.RegisterType((*RewardInfo)(nil), "mechain.sp.RewardInfo")
	proto.RegisterType((*SpStoragePrice)(nil), "mechain.sp.SpStoragePrice")
	proto.RegisterType((*GlobalSpStorePrice)(nil), "mechain.sp.GlobalSpStorePrice")
	proto.RegisterType((*SpMaintenanceStats)(nil), "mechain.sp.SpMaintenanceStats")
	proto.RegisterType((*MaintenanceRecord)(nil), "mechain.sp.MaintenanceRecord")
}

func init() { proto.RegisterFile("mechain/sp/types.proto", fileDescriptor_8cda14ef8a38ca2a) }
