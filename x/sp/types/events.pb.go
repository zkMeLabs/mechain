...
// source: mechain/sp/events.proto
...
type EventCreateStorageProvider struct {
	...
	Status Status `protobuf:"varint,10,opt,name=status,proto3,enum=mechain.sp.Status" json:"status,omitempty"`
...
func init() {
	proto.RegisterType((*EventCreateStorageProvider)(nil), "mechain.sp.EventCreateStorageProvider")
	proto.RegisterType((*EventEditStorageProvider)(nil), "mechain.sp.EventEditStorageProvider")
	proto.RegisterType((*EventDeposit)(nil), "mechain.sp.EventDeposit")
	proto.RegisterType((*EventSpStoragePriceUpdate)(nil), "mechain.sp.EventSpStoragePriceUpdate")
	proto.RegisterType((*EventGlobalSpStorePriceUpdate)(nil), "mechain.sp.EventGlobalSpStorePriceUpdate")
	proto.RegisterType((*EventUpdateStorageProviderStatus)(nil), "mechain.sp.EventUpdateStorageProviderStatus")
}

func init() { proto.RegisterFile("mechain/sp/events.proto", fileDescriptor_cf4befb1250169a1) }
