...
// AutoSettleRecords is a paid mutator transaction binding the contract method 0x2e43a1dc.
//
// Solidity: function autoSettleRecords((bytes,uint64,uint64,bool,bool) pagination) returns((int64,string)[] autoSettleRecords, (bytes,uint64) pageResponse)
func (_IPayment *IPaymentTransactor) AutoSettleRecords(opts *bind.TransactOpts, pagination PageRequest) (*types.Transaction, error) {
	return _IPayment.contract.Transact(opts, "autoSettleRecords", pagination)
}

// AutoSettleRecords is a paid mutator transaction binding the contract method 0x2e43a1dc.
//
// Solidity: function autoSettleRecords((bytes,uint64,uint64,bool,bool) pagination) returns((int64,string)[] autoSettleRecords, (bytes,uint64) pageResponse)
func (_IPayment *IPaymentSession) AutoSettleRecords(pagination PageRequest) (*types.Transaction, error) {
	return _IPayment.Contract.AutoSettleRecords(&_IPayment.TransactOpts, pagination)
}

// AutoSettleRecords is a paid mutator transaction binding the contract method 0x2e43a1dc.
//
// Solidity: function autoSettleRecords((bytes,uint64,uint64,bool,bool) pagination) returns((int64,string)[] autoSettleRecords, (bytes,uint64) pageResponse)
func (_IPayment *IPaymentTransactorSession) AutoSettleRecords(pagination PageRequest) (*types.Transaction, error) {
	return _IPayment.Contract.AutoSettleRecords(&_IPayment.TransactOpts, pagination)
}
...
// DelayedWithdrawal is a paid mutator transaction binding the contract method 0xc23e3f0c.
//
// Solidity: function delayedWithdrawal(string account) returns((string,uint256,string,int64) delayedWithdrawal)
func (_IPayment *IPaymentTransactor) DelayedWithdrawal(opts *bind.TransactOpts, account string) (*types.Transaction, error) {
	return _IPayment.contract.Transact(opts, "delayedWithdrawal", account)
}

// DelayedWithdrawal is a paid mutator transaction binding the contract method 0xc23e3f0c.
//
// Solidity: function delayedWithdrawal(string account) returns((string,uint256,string,int64) delayedWithdrawal)
func (_IPayment *IPaymentSession) DelayedWithdrawal(account string) (*types.Transaction, error) {
	return _IPayment.Contract.DelayedWithdrawal(&_IPayment.TransactOpts, account)
}

// DelayedWithdrawal is a paid mutator transaction binding the contract method 0xc23e3f0c.
//
// Solidity: function delayedWithdrawal(string account) returns((string,uint256,string,int64) delayedWithdrawal)
func (_IPayment *IPaymentTransactorSession) DelayedWithdrawal(account string) (*types.Transaction, error) {
	return _IPayment.Contract.DelayedWithdrawal(&_IPayment.TransactOpts, account)
}
...
// DynamicBalance is a paid mutator transaction binding the contract method 0xab840b84.
//
// Solidity: function dynamicBalance(string account) returns((uint256,(string,int64,uint256,uint256,uint256,uint256,int32,int64,uint64,uint256),int64,uint256,uint256,uint256,uint256) dynamicBalance)
func (_IPayment *IPaymentTransactor) DynamicBalance(opts *bind.TransactOpts, account string) (*types.Transaction, error) {
	return _IPayment.contract.Transact(opts, "dynamicBalance", account)
}

// DynamicBalance is a paid mutator transaction binding the contract method 0xab840b84.
//
// Solidity: function dynamicBalance(string account) returns((uint256,(string,int64,uint256,uint256,uint256,uint256,int32,int64,uint64,uint256),int64,uint256,uint256,uint256,uint256) dynamicBalance)
func (_IPayment *IPaymentSession) DynamicBalance(account string) (*types.Transaction, error) {
	return _IPayment.Contract.DynamicBalance(&_IPayment.TransactOpts, account)
}

// DynamicBalance is a paid mutator transaction binding the contract method 0xab840b84.
//
// Solidity: function dynamicBalance(string account) returns((uint256,(string,int64,uint256,uint256,uint256,uint256,int32,int64,uint64,uint256),int64,uint256,uint256,uint256,uint256) dynamicBalance)
func (_IPayment *IPaymentTransactorSession) DynamicBalance(account string) (*types.Transaction, error) {
	return _IPayment.Contract.DynamicBalance(&_IPayment.TransactOpts, account)
}

// OutFlows is a paid mutator transaction binding the contract method 0x4222d636.
//
// Solidity: function outFlows(string account) returns((string,uint256,int32)[] outFlows)
func (_IPayment *IPaymentTransactor) OutFlows(opts *bind.TransactOpts, account string) (*types.Transaction, error) {
	return _IPayment.contract.Transact(opts, "outFlows", account)
}

// OutFlows is a paid mutator transaction binding the contract method 0x4222d636.
//
// Solidity: function outFlows(string account) returns((string,uint256,int32)[] outFlows)
func (_IPayment *IPaymentSession) OutFlows(account string) (*types.Transaction, error) {
	return _IPayment.Contract.OutFlows(&_IPayment.TransactOpts, account)
}

// OutFlows is a paid mutator transaction binding the contract method 0x4222d636.
//
// Solidity: function outFlows(string account) returns((string,uint256,int32)[] outFlows)
func (_IPayment *IPaymentTransactorSession) OutFlows(account string) (*types.Transaction, error) {
	return _IPayment.Contract.OutFlows(&_IPayment.TransactOpts, account)
}

// Params is a paid mutator transaction binding the contract method 0xcff0ab96.
//
// Solidity: function params() returns(((uint64,uint256),uint64,uint64,uint64,uint64,string,uint256,uint64) params)
func (_IPayment *IPaymentTransactor) Params(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _IPayment.contract.Transact(opts, "params")
}

// Params is a paid mutator transaction binding the contract method 0xcff0ab96.
//
// Solidity: function params() returns(((uint64,uint256),uint64,uint64,uint64,uint64,string,uint256,uint64) params)
func (_IPayment *IPaymentSession) Params() (*types.Transaction, error) {
	return _IPayment.Contract.Params(&_IPayment.TransactOpts)
}

// Params is a paid mutator transaction binding the contract method 0xcff0ab96.
//
// Solidity: function params() returns(((uint64,uint256),uint64,uint64,uint64,uint64,string,uint256,uint64) params)
func (_IPayment *IPaymentTransactorSession) Params() (*types.Transaction, error) {
	return _IPayment.Contract.Params(&_IPayment.TransactOpts)
}

// ParamsByTimestamp is a paid mutator transaction binding the contract method 0x5593d8b8.
//
// Solidity: function paramsByTimestamp(int64 timestamp) returns(((uint64,uint256),uint64,uint64,uint64,uint64,string,uint256,uint64) params)
func (_IPayment *IPaymentTransactor) ParamsByTimestamp(opts *bind.TransactOpts, timestamp int64) (*types.Transaction, error) {
	return _IPayment.contract.Transact(opts, "paramsByTimestamp", timestamp)
}

// ParamsByTimestamp is a paid mutator transaction binding the contract method 0x5593d8b8.
//
// Solidity: function paramsByTimestamp(int64 timestamp) returns(((uint64,uint256),uint64,uint64,uint64,uint64,string,uint256,uint64) params)
func (_IPayment *IPaymentSession) ParamsByTimestamp(timestamp int64) (*types.Transaction, error) {
	return _IPayment.Contract.ParamsByTimestamp(&_IPayment.TransactOpts, timestamp)
}

// ParamsByTimestamp is a paid mutator transaction binding the contract method 0x5593d8b8.
//
// Solidity: function paramsByTimestamp(int64 timestamp) returns(((uint64,uint256),uint64,uint64,uint64,uint64,string,uint256,uint64) params)
func (_IPayment *IPaymentTransactorSession) ParamsByTimestamp(timestamp int64) (*types.Transaction, error) {
	return _IPayment.Contract.ParamsByTimestamp(&_IPayment.TransactOpts, timestamp)
}

// PaymentAccount is a paid mutator transaction binding the contract method 0xe64d2baf.
//
// Solidity: function paymentAccount(string addr) returns((string,string,bool) paymentAccount)
func (_IPayment *IPaymentTransactor) PaymentAccount(opts *bind.TransactOpts, addr string) (*types.Transaction, error) {
	return _IPayment.contract.Transact(opts, "paymentAccount", addr)
}

// PaymentAccount is a paid mutator transaction binding the contract method 0xe64d2baf.
//
// Solidity: function paymentAccount(string addr) returns((string,string,bool) paymentAccount)
func (_IPayment *IPaymentSession) PaymentAccount(addr string) (*types.Transaction, error) {
	return _IPayment.Contract.PaymentAccount(&_IPayment.TransactOpts, addr)
}

// PaymentAccount is a paid mutator transaction binding the contract method 0xe64d2baf.
//
// Solidity: function paymentAccount(string addr) returns((string,string,bool) paymentAccount)
func (_IPayment *IPaymentTransactorSession) PaymentAccount(addr string) (*types.Transaction, error) {
	return _IPayment.Contract.PaymentAccount(&_IPayment.TransactOpts, addr)
}

// PaymentAccountCount is a paid mutator transaction binding the contract method 0xd7e65eb5.
//
// Solidity: function paymentAccountCount(string owner) returns((string,uint64) paymentAccountCount)
func (_IPayment *IPaymentTransactor) PaymentAccountCount(opts *bind.TransactOpts, owner string) (*types.Transaction, error) {
	return _IPayment.contract.Transact(opts, "paymentAccountCount", owner)
}

// PaymentAccountCount is a paid mutator transaction binding the contract method 0xd7e65eb5.
//
// Solidity: function paymentAccountCount(string owner) returns((string,uint64) paymentAccountCount)
func (_IPayment *IPaymentSession) PaymentAccountCount(owner string) (*types.Transaction, error) {
	return _IPayment.Contract.PaymentAccountCount(&_IPayment.TransactOpts, owner)
}

// PaymentAccountCount is a paid mutator transaction binding the contract method 0xd7e65eb5.
//
// Solidity: function paymentAccountCount(string owner) returns((string,uint64) paymentAccountCount)
func (_IPayment *IPaymentTransactorSession) PaymentAccountCount(owner string) (*types.Transaction, error) {
	return _IPayment.Contract.PaymentAccountCount(&_IPayment.TransactOpts, owner)
}

// PaymentAccountCounts is a paid mutator transaction binding the contract method 0x1a101f68.
//
// Solidity: function paymentAccountCounts((bytes,uint64,uint64,bool,bool) pagination) returns((string,uint64)[] paymentAccountCounts, (bytes,uint64) pageResponse)
func (_IPayment *IPaymentTransactor) PaymentAccountCounts(opts *bind.TransactOpts, pagination PageRequest) (*types.Transaction, error) {
	return _IPayment.contract.Transact(opts, "paymentAccountCounts", pagination)
}

// PaymentAccountCounts is a paid mutator transaction binding the contract method 0x1a101f68.
//
// Solidity: function paymentAccountCounts((bytes,uint64,uint64,bool,bool) pagination) returns((string,uint64)[] paymentAccountCounts, (bytes,uint64) pageResponse)
func (_IPayment *IPaymentSession) PaymentAccountCounts(pagination PageRequest) (*types.Transaction, error) {
	return _IPayment.Contract.PaymentAccountCounts(&_IPayment.TransactOpts, pagination)
}

// PaymentAccountCounts is a paid mutator transaction binding the contract method 0x1a101f68.
//
// Solidity: function paymentAccountCounts((bytes,uint64,uint64,bool,bool) pagination) returns((string,uint64)[] paymentAccountCounts, (bytes,uint64) pageResponse)
func (_IPayment *IPaymentTransactorSession) PaymentAccountCounts(pagination PageRequest) (*types.Transaction, error) {
	return _IPayment.Contract.PaymentAccountCounts(&_IPayment.TransactOpts, pagination)
}

// PaymentAccounts is a paid mutator transaction binding the contract method 0x1757a1ee.
//
// Solidity: function paymentAccounts((bytes,uint64,uint64,bool,bool) pagination) returns((string,string,bool)[] paymentAccounts, (bytes,uint64) pageResponse)
func (_IPayment *IPaymentTransactor) PaymentAccounts(opts *bind.TransactOpts, pagination PageRequest) (*types.Transaction, error) {
	return _IPayment.contract.Transact(opts, "paymentAccounts", pagination)
}

// PaymentAccounts is a paid mutator transaction binding the contract method 0x1757a1ee.
//
// Solidity: function paymentAccounts((bytes,uint64,uint64,bool,bool) pagination) returns((string,string,bool)[] paymentAccounts, (bytes,uint64) pageResponse)
func (_IPayment *IPaymentSession) PaymentAccounts(pagination PageRequest) (*types.Transaction, error) {
	return _IPayment.Contract.PaymentAccounts(&_IPayment.TransactOpts, pagination)
}

// PaymentAccounts is a paid mutator transaction binding the contract method 0x1757a1ee.
//
// Solidity: function paymentAccounts((bytes,uint64,uint64,bool,bool) pagination) returns((string,string,bool)[] paymentAccounts, (bytes,uint64) pageResponse)
func (_IPayment *IPaymentTransactorSession) PaymentAccounts(pagination PageRequest) (*types.Transaction, error) {
	return _IPayment.Contract.PaymentAccounts(&_IPayment.TransactOpts, pagination)
}

// PaymentAccountsByOwner is a paid mutator transaction binding the contract method 0x8909f228.
//
// Solidity: function paymentAccountsByOwner(string owner) returns(string[] accounts)
func (_IPayment *IPaymentTransactor) PaymentAccountsByOwner(opts *bind.TransactOpts, owner string) (*types.Transaction, error) {
	return _IPayment.contract.Transact(opts, "paymentAccountsByOwner", owner)
}

// PaymentAccountsByOwner is a paid mutator transaction binding the contract method 0x8909f228.
//
// Solidity: function paymentAccountsByOwner(string owner) returns(string[] accounts)
func (_IPayment *IPaymentSession) PaymentAccountsByOwner(owner string) (*types.Transaction, error) {
	return _IPayment.Contract.PaymentAccountsByOwner(&_IPayment.TransactOpts, owner)
}

// PaymentAccountsByOwner is a paid mutator transaction binding the contract method 0x8909f228.
//
// Solidity: function paymentAccountsByOwner(string owner) returns(string[] accounts)
func (_IPayment *IPaymentTransactorSession) PaymentAccountsByOwner(owner string) (*types.Transaction, error) {
	return _IPayment.Contract.PaymentAccountsByOwner(&_IPayment.TransactOpts, owner)
}

// StreamRecord is a paid mutator transaction binding the contract method 0x56965b8f.
//
// Solidity: function streamRecord(string account) returns((string,int64,uint256,uint256,uint256,uint256,int32,int64,uint64,uint256) streamRecord)
func (_IPayment *IPaymentTransactor) StreamRecord(opts *bind.TransactOpts, account string) (*types.Transaction, error) {
	return _IPayment.contract.Transact(opts, "streamRecord", account)
}

// StreamRecord is a paid mutator transaction binding the contract method 0x56965b8f.
//
// Solidity: function streamRecord(string account) returns((string,int64,uint256,uint256,uint256,uint256,int32,int64,uint64,uint256) streamRecord)
func (_IPayment *IPaymentSession) StreamRecord(account string) (*types.Transaction, error) {
	return _IPayment.Contract.StreamRecord(&_IPayment.TransactOpts, account)
}

// StreamRecord is a paid mutator transaction binding the contract method 0x56965b8f.
//
// Solidity: function streamRecord(string account) returns((string,int64,uint256,uint256,uint256,uint256,int32,int64,uint64,uint256) streamRecord)
func (_IPayment *IPaymentTransactorSession) StreamRecord(account string) (*types.Transaction, error) {
	return _IPayment.Contract.StreamRecord(&_IPayment.TransactOpts, account)
}

// StreamRecords is a paid mutator transaction binding the contract method 0x33e16e34.
//
// Solidity: function streamRecords((bytes,uint64,uint64,bool,bool) pagination) returns((string,int64,uint256,uint256,uint256,uint256,int32,int64,uint64,uint256)[] streamRecords, (bytes,uint64) pageResponse)
func (_IPayment *IPaymentTransactor) StreamRecords(opts *bind.TransactOpts, pagination PageRequest) (*types.Transaction, error) {
	return _IPayment.contract.Transact(opts, "streamRecords", pagination)
}

// StreamRecords is a paid mutator transaction binding the contract method 0x33e16e34.
//
// Solidity: function streamRecords((bytes,uint64,uint64,bool,bool) pagination) returns((string,int64,uint256,uint256,uint256,uint256,int32,int64,uint64,uint256)[] streamRecords, (bytes,uint64) pageResponse)
func (_IPayment *IPaymentSession) StreamRecords(pagination PageRequest) (*types.Transaction, error) {
	return _IPayment.Contract.StreamRecords(&_IPayment.TransactOpts, pagination)
}

// StreamRecords is a paid mutator transaction binding the contract method 0x33e16e34.
//
// Solidity: function streamRecords((bytes,uint64,uint64,bool,bool) pagination) returns((string,int64,uint256,uint256,uint256,uint256,int32,int64,uint64,uint256)[] streamRecords, (bytes,uint64) pageResponse)
func (_IPayment *IPaymentTransactorSession) StreamRecords(pagination PageRequest) (*types.Transaction, error) {
	return _IPayment.Contract.StreamRecords(&_IPayment.TransactOpts, pagination)
}
