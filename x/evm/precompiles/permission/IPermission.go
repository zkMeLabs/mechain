...
//
// Solidity: function params() returns((uint64,uint64,uint64) params)
func (_IPermission *IPermissionTransactor) Params(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _IPermission.contract.Transact(opts, "params")
}

// Params is a paid mutator transaction binding the contract method 0xcff0ab96.
//
// Solidity: function params() returns((uint64,uint64,uint64) params)
func (_IPermission *IPermissionSession) Params() (*types.Transaction, error) {
	return _IPermission.Contract.Params(&_IPermission.TransactOpts)
}

// Params is a paid mutator transaction binding the contract method 0xcff0ab96.
//
// Solidity: function params() returns((uint64,uint64,uint64) params)
func (_IPermission *IPermissionTransactorSession) Params() (*types.Transaction, error) {
	return _IPermission.Contract.Params(&_IPermission.TransactOpts)
}
