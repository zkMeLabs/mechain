...
//
// Solidity: function proposal(uint64 proposalId) view returns((uint64,string[],uint8,(string,string,string,string),int64,int64,(string,uint256)[],int64,int64,string,string,string) proposal)
...
//
// Solidity: function proposals(uint8 status, address voter, address depositor, (bytes,uint64,uint64,bool,bool) pagination) view returns((uint64,string[],uint8,(string,string,string,string),int64,int64,(string,uint256)[],int64,int64,string,string,string)[] proposals, (bytes,uint64) pageResponse)
