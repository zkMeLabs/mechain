...
// UpdateBucketInfo is a paid mutator transaction binding the contract method 0xea271848.
//
// Solidity: function updateBucketInfo(string bucketName, int8 visibility, address paymentAddress, int128 chargedReadQuota) returns(bool success)
func (_IStorage *IStorageTransactor) UpdateBucketInfo(opts *bind.TransactOpts, bucketName string, visibility int8, paymentAddress common.Address, chargedReadQuota *big.Int) (*types.Transaction, error) {
...
//
// Solidity: function updateBucketInfo(string bucketName, int8 visibility, address paymentAddress, int128 chargedReadQuota) returns(bool success)
func (_IStorage *IStorageSession) UpdateBucketInfo(bucketName string, visibility int8, paymentAddress common.Address, chargedReadQuota *big.Int) (*types.Transaction, error) {
...
//
// Solidity: function updateBucketInfo(string bucketName, int8 visibility, address paymentAddress, int128 chargedReadQuota) returns(bool success)
func (_IStorage *IStorageTransactorSession) UpdateBucketInfo(bucketName string, visibility int8, paymentAddress common.Address, chargedReadQuota *big.Int) (*types.Transaction, error) {
	return _IStorage.Contract.UpdateBucketInfo(&_IStorage.TransactOpts, bucketName, visibility, paymentAddress, chargedReadQuota)
}
...
// FilterUpdateBucketInfo is a free log retrieval operation binding the contract event 0x2fe6115cdee7ea6c497ddeb8ebba7ea37fd5c734454d171ba18f344787256926.
//
// Solidity: event UpdateBucketInfo(address indexed operator, bytes32 indexed bucketName, address indexed paymentAddress, int8 Visibility)
...
// WatchUpdateBucketInfo is a free log subscription operation binding the contract event 0x2fe6115cdee7ea6c497ddeb8ebba7ea37fd5c734454d171ba18f344787256926.
//
// Solidity: event UpdateBucketInfo(address indexed operator, bytes32 indexed bucketName, address indexed paymentAddress, int8 Visibility)
...
// ParseUpdateBucketInfo is a log parse operation binding the contract event 0x2fe6115cdee7ea6c497ddeb8ebba7ea37fd5c734454d171ba18f344787256926.
//
// Solidity: event UpdateBucketInfo(address indexed operator, bytes32 indexed bucketName, address indexed paymentAddress, int8 Visibility)
