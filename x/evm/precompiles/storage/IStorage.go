...
// FilterUpdateBucketInfo is a free log retrieval operation binding the contract event 0xefac930de2e880815563ae7db68da9dcff1562f5e32662e1af20f55992cec5fe.
//
// Solidity: event UpdateBucketInfo(address indexed operator, string indexed bucketName, address indexed PaymentAddress, uint8 Visibility)
func (_IStorage *IStorageFilterer) FilterUpdateBucketInfo(opts *bind.FilterOpts, operator []common.Address, bucketName []string, PaymentAddress []common.Address) (*IStorageUpdateBucketInfoIterator, error) {
...
// WatchUpdateBucketInfo is a free log subscription operation binding the contract event 0xefac930de2e880815563ae7db68da9dcff1562f5e32662e1af20f55992cec5fe.
//
// Solidity: event UpdateBucketInfo(address indexed operator, string indexed bucketName, address indexed PaymentAddress, uint8 Visibility)
func (_IStorage *IStorageFilterer) WatchUpdateBucketInfo(opts *bind.WatchOpts, sink chan<- *IStorageUpdateBucketInfo, operator []common.Address, bucketName []string, PaymentAddress []common.Address) (event.Subscription, error) {
...
// ParseUpdateBucketInfo is a log parse operation binding the contract event 0xefac930de2e880815563ae7db68da9dcff1562f5e32662e1af20f55992cec5fe.
//
// Solidity: event UpdateBucketInfo(address indexed operator, string indexed bucketName, address indexed PaymentAddress, uint8 Visibility)
