...
//
// Solidity: function headObject(string bucketName, string objectName) view returns((address,address,string,string,uint256,uint32,uint64,uint8,string,int64,uint8,uint8,uint8,string[],(string,string)[],bool,int64,address,int64) objectInfo)
func (_IStorage *IStorageCaller) HeadObject(opts *bind.CallOpts, bucketName string, objectName string) (ObjectInfo, error) {
	var out []interface{}
	err := _IStorage.contract.Call(opts, &out, "headObject", bucketName, objectName)

	if err != nil {
		return *new(ObjectInfo), err
	}

	out0 := *abi.ConvertType(out[0], new(ObjectInfo)).(*ObjectInfo)
...
//
// Solidity: function headObject(string bucketName, string objectName) view returns((address,address,string,string,uint256,uint32,uint64,uint8,string,int64,uint8,uint8,uint8,string[],(string,string)[],bool,int64,address,int64) objectInfo)
func (_IStorage *IStorageSession) HeadObject(bucketName string, objectName string) (ObjectInfo, error) {
...
//
// Solidity: function headObject(string bucketName, string objectName) view returns((address,address,string,string,uint256,uint32,uint64,uint8,string,int64,uint8,uint8,uint8,string[],(string,string)[],bool,int64,address,int64) objectInfo)
func (_IStorage *IStorageCallerSession) HeadObject(bucketName string, objectName string) (ObjectInfo, error) {
	return _IStorage.Contract.HeadObject(&_IStorage.CallOpts, bucketName, objectName)
}

// HeadObjectById is a free data retrieval call binding the contract method 0xfce9b24b.
//
// Solidity: function headObjectById(string objectId) view returns((address,address,string,string,uint256,uint32,uint64,uint8,string,int64,uint8,uint8,uint8,string[],(string,string)[],bool,int64,address,int64) objectInfo)
func (_IStorage *IStorageCaller) HeadObjectById(opts *bind.CallOpts, objectId string) (ObjectInfo, error) {
	var out []interface{}
...
//
// Solidity: function headObjectById(string objectId) view returns((address,address,string,string,uint256,uint32,uint64,uint8,string,int64,uint8,uint8,uint8,string[],(string,string)[],bool,int64,address,int64) objectInfo)
func (_IStorage *IStorageSession) HeadObjectById(objectId string) (ObjectInfo, error) {
...
//
// Solidity: function headObjectById(string objectId) view returns((address,address,string,string,uint256,uint32,uint64,uint8,string,int64,uint8,uint8,uint8,string[],(string,string)[],bool,int64,address,int64) objectInfo)
func (_IStorage *IStorageCallerSession) HeadObjectById(objectId string) (ObjectInfo, error) {
	return _IStorage.Contract.HeadObjectById(&_IStorage.CallOpts, objectId)
}
