...
// UpdateBucketInfo is a paid mutator transaction binding the contract method 0x693c1e51.
//
// Solidity: function updateBucketInfo(string bucketName, uint8 visibility, address paymentAddress, uint64 chargedReadQuota, uint8 updateMask) returns(bool success)
func (_IStorage *IStorageTransactor) UpdateBucketInfo(opts *bind.TransactOpts, bucketName string, visibility uint8, paymentAddress common.Address, chargedReadQuota uint64, updateMask uint8) (*types.Transaction, error) {
	return _IStorage.contract.Transact(opts, "updateBucketInfo", bucketName, visibility, paymentAddress, chargedReadQuota, updateMask)
}

// UpdateBucketInfo is a paid mutator transaction binding the contract method 0x693c1e51.
//
// Solidity: function updateBucketInfo(string bucketName, uint8 visibility, address paymentAddress, uint64 chargedReadQuota, uint8 updateMask) returns(bool success)
func (_IStorage *IStorageSession) UpdateBucketInfo(bucketName string, visibility uint8, paymentAddress common.Address, chargedReadQuota uint64, updateMask uint8) (*types.Transaction, error) {
	return _IStorage.Contract.UpdateBucketInfo(&_IStorage.TransactOpts, bucketName, visibility, paymentAddress, chargedReadQuota, updateMask)
}

// UpdateBucketInfo is a paid mutator transaction binding the contract method 0x693c1e51.
//
// Solidity: function updateBucketInfo(string bucketName, uint8 visibility, address paymentAddress, uint64 chargedReadQuota, uint8 updateMask) returns(bool success)
func (_IStorage *IStorageTransactorSession) UpdateBucketInfo(bucketName string, visibility uint8, paymentAddress common.Address, chargedReadQuota uint64, updateMask uint8) (*types.Transaction, error) {
	return _IStorage.Contract.UpdateBucketInfo(&_IStorage.TransactOpts, bucketName, visibility, paymentAddress, chargedReadQuota, updateMask)
}
