...
interface IStorage {
    ...
    function HeadBucketExtra(
        string memory bucketName
    ) external view returns (InternalBucketInfo memory extraInfo);
    ...
    ) external view returns (BucketMetaData memory bucketMetaData);
    ...
    function headObjectNFT(
        string memory tokenId
    ) external view returns (ObjectMetaData memory objectMetaData);
    ...
    function headGroupNFT(
        string memory tokenId
    ) external view returns (GroupMetaData memory groupMetaData);
    ...
    function queryIsPriceChanged(
        string memory bucketName
    ) external view returns (IsPriceChanged memory isPriceChanged);
    ...
    function headShadowObject(
        string memory bucketName,
        string memory objectName
    ) external view returns (ShadowObjectInfo memory objectInfo);
