...
interface IPayment {
    ...
    function paymentAccountsByOwner(
        string memory owner
    ) external returns (string[] memory accounts);
    ...
    function paymentAccount(
        string memory addr
    ) external returns (PaymentAccount memory paymentAccount);
    ...
    function paymentAccountCount(
        string memory owner
    ) external returns (PaymentAccountCount memory paymentAccountCount);
     ...
     */
    function params() external returns (Params memory params);
    ...
    function paramsByTimestamp(
        int64 timestamp
    ) external returns (Params memory params);
    ...
    ) external returns (OutFlow[] memory outFlows);
    ...
    function streamRecord(
        string memory account
    ) external returns (StreamRecord memory streamRecord);
    ...
    function dynamicBalance(
        string memory account
    ) external returns (DynamicBalance memory dynamicBalance);
    ...
    function delayedWithdrawal(
        string memory account
    ) external returns (DelayedWithdrawalRecord memory delayedWithdrawal);
