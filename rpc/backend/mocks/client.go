...
func (_m *Client) BroadcastVote(ctx context.Context, vote votepool.Vote) (*coretypes.ResultBroadcastVote, error) {
	return nil, nil
}

func (_m *Client) QueryVote(ctx context.Context, eventType int, eventHash []byte) (*coretypes.ResultQueryVote, error) {
	return nil, nil
}
...
func (_m *Client) BroadcastVote(ctx context.Context, vote votepool.Vote) (*ctypes.ResultBroadcastVote, error) {
	// TODO(alex): add mock method
	return nil,nil
}
func(_m *Client) QueryVote(ctx context.Context, eventType int, eventHash []byte) (*ctypes.ResultQueryVote, error){
	// TODO(alex): add mock method
	return nil,nil
}
